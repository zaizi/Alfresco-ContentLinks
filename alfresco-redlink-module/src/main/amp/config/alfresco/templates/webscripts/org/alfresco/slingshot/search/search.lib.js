 ...
 */
function processResults(nodes, facets, maxResults, rootNode)
{
   // empty cache state
   processedCache = {};
   var results = [],
...
function getSearchResults(params)
{
   ...
   if (ftsQuery.length !== 0)
   {
      ...
      var result = sensefySearch.query(queryDef);
      nodes = result[0];
      facets = result[1];
   }
   else
   ...
   return processResults(nodes, facets, params.maxResults, rootNode);
}
