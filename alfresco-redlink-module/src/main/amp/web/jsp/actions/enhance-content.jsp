...
<r:page titleId="title_action_enhance_content">
...
<f:view>
   ...
   <h:form acceptcharset="UTF-8" id="enhance-content-action">
                        ...
                        <tr>
                           <td width="100%" valign="top">
                              ...
                              <table cellpadding="2" cellspacing="2" border="0" width="100%">
                                 ...
                                 <tr>
                                    <td><nobr><h:outputText value="#{msg.sensefy_enhancement_language}"/></nobr></td>
                                    <td>
                                       <h:selectBooleanCheckbox value="#{WizardManager.bean.actionProperties.language}"/>
                                    </td>
                                 </tr>
                                 <tr>
                                    <td><nobr><h:outputText value="#{msg.sensefy_enhancement_entities}"/></nobr></td>
                                    <td>
                                       <h:selectBooleanCheckbox value="#{WizardManager.bean.actionProperties.entities}"/>
                                    </td>
                                 </tr>
